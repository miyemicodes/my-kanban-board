...
function Header() {
  ...
  return (
    <>
      <section className="bg-[#2d2c37] text-white flex justify-between w-full  px-5 py-7 relative">
        <div className="w-1/4 ">
        ...
        <div className="flex items-center justify-end text-sm gap-4 w-3/4">
          <button
            type="submit"
            onClick={onClick}
            className="flex gap-2 bg-[#795fc5] rounded-3xl px-3 py-2 font-semibold hover:bg-[#af9af0]"
          >
            <FaPlus />
            <p>Add New Task</p>
          </button>
